...
class PermissionGroup extends Model
{
    ...
    protected $table = 'st_permission_group';
    ...
    {
        return $this->hasMany(PermissionGroupDetail::class, 'st_permission_group_id', 'id');
    }
    
    public function group_users()
    {
        return $this->hasMany(PermissionGroupUser::class, 'st_permission_group_id', 'id');
    }
